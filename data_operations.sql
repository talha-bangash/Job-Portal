...
-- ------------------------------------------------------------
INSERT INTO APPLICANTS (ApplicantID, UserID, ResumeURL, ExperienceYears, Bio, Gender, University) 
VALUES 
(1, 4, 'https://cdn.talentbridge.io/resumes/daniel_osei.pdf', 3, 'Full-stack developer with a passion for clean APIs.', 'Male', 'University of Ghana'), 
(2, 5, 'https://cdn.talentbridge.io/resumes/sofia_alves.pdf', 5, 'Data scientist specialising in predictive modelling.', 'Female', 'University of Sao Paulo'), 
(3, 6, 'https://cdn.talentbridge.io/resumes/liam_nguyen.pdf', 2, 'Junior DevOps engineer eager to automate everything.', 'Male', 'Oregon State University'), 
(4, 7, NULL, 1, 'Recent design graduate with a strong UI/UX portfolio.', 'Female', 'American University of Beirut');
-- ------------------------------------------------------------
-- 2.4  JOBS  (4 open + 1 closed position across the 3 companies)
-- Note: SKILLS seed rows already exist from schema.sql (SkillID 1-32)
-- ------------------------------------------------------------
INSERT INTO JOBS (JobID, Title, Description, CompanyID, WorkLocation, Salary, Deadline, Status) 
VALUES 
(1, 'Backend Python Developer', 'Build and maintain RESTful APIs using Flask and PostgreSQL.', 5, 'Remote', 85000.00, '2025-08-31', 'Open'), 
(2, 'Data Scientist', 'Develop ML models to optimise energy consumption forecasting.', 4, 'Austin, TX', 92000.00, '2025-07-15', 'Open'), 
(3, 'DevOps Engineer', 'Manage CI/CD pipelines and Kubernetes clusters on AWS.', 3, 'Seattle, WA', 98000.00, '2025-09-01', 'Open'), 
(4, 'UI/UX Designer', 'Design intuitive interfaces for our SaaS dashboard product.', 5, 'San Francisco, CA', 75000.00, '2025-07-30', 'Open'), 
(5, 'Junior Data Analyst', 'Support the analytics team with reporting and data visualisation.', 4, 'Remote', 58000.00, '2025-06-30', 'Closed');
-- ------------------------------------------------------------
...
-- ------------------------------------------------------------
INSERT IGNORE INTO JOB_SKILLS (JobID, SkillID, RequirementLevel) 
VALUES 
(1, 1,  'Expert'),         
(1, 5,  'Intermediate'),   
(2, 16, 'Expert'),         
